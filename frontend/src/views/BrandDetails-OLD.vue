  ...
  <div class="row row-break">
    ...
    <div class="row row-cards">
        <div class="row">
            ...
            <div class="col s9 m9 l9 plain-element">
        ...
        <div class="row plain-element">
            <table id="dataTable">
                <thead>
                    <tr>
                      <th onclick="sortTable(0)" class="left-align">Product Name</th>
                      <th onclick="sortTable(1)" class="left-align">Product Category</th>
                ...
                <tbody>
                    <tr v-for="product in filteredProductList" :key="product.pk">
                      <td class="left-align field-medium">{{ product.product_name }}</td>
                      <td class="left-align field-medium">{{ product.product_category }}</td>
                      <td class="left-align field-long">{{ product.product_series }}</td>
